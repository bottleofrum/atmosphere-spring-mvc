...
<body>
	...
	<script src="<c:url value="/jquery/jquery-1.9.0-min.js" />"></script>
	<script src="<c:url value="/jquery/jquery.atmosphere-min.js" />"></script>
    <script src="<c:url value="/resources/js/bootstrap.min.js" />"></script>

    <tilesx:useAttribute id="js" name="js" classname="java.util.List" ignore="true" />
    <c:forEach var="jscript" items="${js}">
        <script src="<c:url value="/resources/js/${jscript}" />"></script>
    </c:forEach>
